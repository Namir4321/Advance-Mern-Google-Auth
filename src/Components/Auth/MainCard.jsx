...
export const MainCard = () => {
  ...
  console.log(packall)
  return (
    <div className="main-card  my-4  bg-light" style={{ borderRadius: "20px" }}>
      {packall ? (
        packall.map((item) => (
          <>
            ...
            <div className="container-fluid d-flex border p-2 justify-content-between">
              <h6>{item.title}</h6>
              <p
            ...
            <div className="container-fluid d-flex">
             {item.Things.map(items=>(
              ...
              <div className="container-fluid d-flex justify-content-between">
                <div className="custom-list text-start">
                  <ul>
                    <li>{items}</li>
                    <li>Hotel Stay</li>
                    <li>Car Rental</li>
            ...
            <div
              className="p-1 d-flex  justify-content-between text-center"
              style={{
                background: "#DADADA",
                width: "99%",
                margin: "0 auto",
